...
var game = {
	...
	draw: function () {
		...
		this.context.strokeStyle = '#6600FF'
		this.context.stroke()
	...
	update: function () {
		if (!this.over) {
			...
			if (this.ball.x >= this.canvas.width - this.ball.width)
				pong._resetTurn.call(this, this.player, this.bat)
			...
			if (this.bat.y >= this.canvas.height - this.bat.height)
				this.bat.y = this.canvas.height - this.bat.height
			...
			if (
				this.ball.x - this.ball.width <= this.bat.x &&
				this.ball.x >= this.bat.x - this.bat.width
			) {
				if (
					this.ball.y <= this.bat.y + this.bat.height &&
					this.ball.y + this.ball.height >= this.bat.y
				) {
